                    ...
                    <el-row>
                        ...
                        <el-col :span="8">
                            <div style="text-align: right;">
                                ...
                                <el-button @click="$share('/project/'+item.name)" style="padding: 3px 0" type="text" icon="el-icon-share"></el-button>
                            </div>
                        </el-col>
                    </el-row>
                </div>
                ...
                this.projects = [
                    {
                        id: 233183490,
                        name: 'canvas-utils',
                        url: 'https://github.com/GitHub-Laziji/canvas-utils',
                        ...
                        language: 'javascript',
                        license: 'MIT',
                        createTime: '2020-01-11T05:51:24Z',
                        updateTime: '2020-01-21T14:23:50Z',
                        hide: false
                    }
                ]
            },
